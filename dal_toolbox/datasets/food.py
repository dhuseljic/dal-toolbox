...
class Food101(BaseData):
    ...
    def download_datasets(self):
        torchvision.datasets.Food101(self.dataset_path, split="train", download=True)
        torchvision.datasets.Food101(self.dataset_path, split="test", download=True)

    @property
    def full_train_dataset(self):
        return torchvision.datasets.Food101(self.dataset_path, split="train", transform=self.train_transform)

    @property
    def full_train_dataset_eval_transforms(self):
        return torchvision.datasets.Food101(self.dataset_path, split="train", transform=self.eval_transform)

    @property
    def full_train_dataset_query_transforms(self):
        return torchvision.datasets.Food101(self.dataset_path, split="train", transform=self.query_transform)

    @property
    def test_dataset(self):
        return torchvision.datasets.Food101(self.dataset_path, split="test", transform=self.eval_transform)
