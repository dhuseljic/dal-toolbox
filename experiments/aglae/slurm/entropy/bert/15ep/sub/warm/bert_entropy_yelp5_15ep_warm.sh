...
#SBATCH --job-name=glae_banks77_entropy_bert_15ep_warm
...
ACQ_SIZE=100
N_ACQ=15
GROUP=bert_entropy_banks77_15ep_warm
SEED=$SLURM_ARRAY_TASK_ID
N_EPOCHS=15

init_pool_file=~/projects/dal-toolbox/experiments/aglae/initial_pools/yelp5/random_${N_INIT}_seed${SEED}.json
