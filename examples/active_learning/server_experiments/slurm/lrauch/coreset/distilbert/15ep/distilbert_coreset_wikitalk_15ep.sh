...
#SBATCH --job-name=glae_wikitalk_coreset_distilbert_15ep
...
ACQ_SIZE=100
N_ACQ=15
GROUP=distilbert_coreset_wikitalk_15ep
N_EPOCHS=15

OUTPUT_DIR=/mnt/work/glae/glae-results/${DATASET}/$MODEL/${STRATEGY}/15_ep/N_INIT${N_INIT}__ACQ_SIZE${ACQ_SIZE}__N_ACQ${N_ACQ}/seed${SLURM_ARRAY_TASK_ID}
