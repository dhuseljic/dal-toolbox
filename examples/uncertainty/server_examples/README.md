...
The results can be reproduced by running the settings available in the [slurm script](./slurm/uncertainty_study.sh). In general, an experiment can be started by running the command
