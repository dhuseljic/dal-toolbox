...
#SBATCH --output=/mnt/work/dhuseljic/logs/uncertainty_evaluation/sngp/kernel_scale/%x_%A_%a.log
#SBATCH --array=1-5%10
date;hostname;pwd
...
OUTPUT_DIR=$RESULT_DIR/sngp/samples$N_SAMPLES/scale${KERNEL_SCALE}/seed${SLURM_ARRAY_TASK_ID}/
