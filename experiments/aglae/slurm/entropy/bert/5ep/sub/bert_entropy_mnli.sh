...
#SBATCH --job-name=glae_mnli_entropy_bert
...
ACQ_SIZE=100
N_ACQ=15
GROUP=bert_entropy_mnli
random_seed=$SLURM_ARRAY_TASK_ID

init_pool_file=~/projects/dal-toolbox/experiments/aglae/initial_pools/mnli/random_${n_init}_seed${random_seed}.json
