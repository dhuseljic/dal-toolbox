...
output_dir=/mnt/stud/home/ynagel/dal-toolbox/results/al_baselines/${dataset}_supervised/${model}/${al_strat}_${init_strategy}/N_INIT${n_init}__ACQ_SIZE${acq_size}__N_ACQ${n_acq}/seed${random_seed}/
...
srun python -u active_learning.py \
	...
	precomputed_features_dir=/mnt/stud/home/ynagel/data/supervised_resnet18_deterministic_SVHN_0.962.pth
