...
#SBATCH --job-name=glae_yelp5_entropy_bert
...
ACQ_SIZE=100
N_ACQ=15
GROUP=bert_entropy_yelp5
random_seed=$SLURM_ARRAY_TASK_ID

init_pool_file=~/projects/dal-toolbox/experiments/aglae/initial_pools/yelp5/random_${n_init}_seed${random_seed}.json
