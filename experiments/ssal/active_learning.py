...
def main(args):
    ...
    train_ds = DinoFeatureDataset(dino_model, dataset=data.train_dataset, normalize_features=True, cache=True)
    test_ds = DinoFeatureDataset(dino_model, dataset=data.val_dataset, normalize_features=True, cache=True)
