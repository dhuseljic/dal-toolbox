...
#SBATCH --job-name=glae_banks77_entropy_bert
...
ACQ_SIZE=100
N_ACQ=15
GROUP=bert_entropy_banks77
random_seed=$SLURM_ARRAY_TASK_ID

init_pool_file=~/projects/dal-toolbox/experiments/aglae/initial_pools/banks77/random_${n_init}_seed${random_seed}.json
