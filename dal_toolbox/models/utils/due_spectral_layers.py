# Combination of the following three files
# 1. https://github.com/y0ast/DUE/blob/main/due/layers/spectral_norm_fc.py
# 2. https://github.com/y0ast/DUE/blob/main/due/layers/spectral_norm_conv.py
# 3. https://github.com/y0ast/DUE/blob/main/due/layers/spectral_batchnorm.py
